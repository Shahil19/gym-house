...
const Banner = () => {
    return (
        <div>
            <div className="text-center flex flex-col p-4 md:text-left md:flex-row md:items-center md:justify-between md:p-12 bg-purple-100 rounded-md">
                <div className="text-2xl font-semibold">
                    <div className="text-gray-900">Lorem ipsum dolor sit amet consectetur adipisicing elit.</div>
                    <div className="text-purple-500">Start your Free Trial.</div>
                </div>
